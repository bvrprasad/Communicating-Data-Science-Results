...
Plotting the various incidents on a day-by-day basis tends to show many correlations, say, between ARSON, KIDNAPPING, FRAUD, etc. But, it's difficult so say this which ones have better correlation from such a graph.
...
ggplot(daily, aes(Date, Count)) + 
  facet_wrap(~ Category, ncol = 5) + 
  labs(title = "Day-by-day incidents variantions", x = "Day", y = "Incidents count") +
  theme(axis.text.y = element_text(size = 6, color = "blue")) +
